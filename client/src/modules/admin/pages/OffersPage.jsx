...
const OffersPage = () => {
  ...
  const load = async () => { try { const r = await getOffers({ status: filter }); setOffers(r.data.data.offers || r.data.data); } catch (e) {} setLoading(false); };
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {offers.length === 0 ? <p className="text-text-muted col-span-2">No offers found</p> :
          offers.map(o => (
